...
public class BottomSingleView extends View {
	...
	private void initAttri(Context context , AttributeSet attrs ,  int defStyle){
		...
		changeColor = typedArray.getColor(R.styleable.easyweixin_textColor, R.color.defult_text_color);
		...
		normalBitmap = ((BitmapDrawable)typedArray.getDrawable(R.styleable.easyweixin_normalBitmap)).getBitmap(); 
		pitchBitmap = ((BitmapDrawable)typedArray.getDrawable(R.styleable.easyweixin_pitchBitmap)).getBitmap(); 
		boolean alpha = typedArray.getBoolean(R.styleable.easyweixin_alpha, false) ; 
		typedArray.recycle();  
		currentAlpha = alpha ? 255 : 0 ; 
		textColor = alpha ? changeColor : getResources().getColor(R.color.defult_text_color) ; 
	}
	...
	private int DEFULT_TEXT_COLOR  = getResources().getColor(R.color.defult_text_color);
